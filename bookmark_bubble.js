...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  bubble.appendChild(bubbleInner);
	...
	if (isAndroid) { 
		bubbleInner.innerHTML = '<b>Install this app:</b><br /> ' +
	      '1) Add to Bookmarks,<br /> 2) Tap and Hold the bookmark,<br /> 3) Select "<b>Add Shortcut to Home</b>"'; 
	    bubbleInner.style.font = '0.625em sans-serif';
	} else if(isBlackBerry) {
		bubbleInner.innerHTML = '<b>Install this app:</b><br /> ' +
		      'Tap <img src="'+ this.IMAGE_BLACKBERRY_ICON_DATA_URL_ +'" style="height: 1em;display: inline-block;padding:0;margin:0" />, select "<b>Add to Home Screen</b>"'; 
	} else if(isPlayBook) {
		bubbleInner.innerHTML = '<b>Install this app:</b><br />' +
		      'Tap <img src="'+ this.IMAGE_PLAYBOOK_BOOKMARK_DATA_URL_ +'" style="height: 1.5em;display: inline-block;padding:0;margin:0;" />, select  <br />"<b>Add to Home Screen</b>"'; 
		bubbleInner.style.position = 'absolute';
		bubbleInner.style.right = '0px';
	} else {
	
	  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
	  bubbleInner.innerHTML = '<b>Install this app</b>:<br /> Tap ' +
	      '<img src="'+ this.IMAGE_SAFARI_FORWARD_DATA_URL_ +'" style="height: 1em;display: inline-block;padding: 0;margin: 0" /> and then <b>"Add to Home Screen"</b>';
	  } else {
	    bubbleInner.innerHTML = '<b>Install this app</b>:<br /> ' +
  ...
  close.style.width = '2.75em';
  close.style.height = '2.75em';
